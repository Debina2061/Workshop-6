...
class Program
{
    static void Main(string[] args)
    {
        Tour[] tours =
        [
            new("Debina", "Pharping", 8000, 3, false),
            new("David", "Ithari", 45000, 5, true),
            new("Kamana", "Hetauda", 12000, 4, false),
            new("Sandhya", "Lagankhel", 60000, 6, true),
            new("Prince", "Lalitpur", 15000, 5, false),
            new("Shafal", "Bhoddha", 38000, 7, true),
        ];
